...
using RentalKendaraan_20180140052.Models;

namespace RentalKendaraan_20180140052.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ktsd, string searchString, string sortOrder, string currentFilter, int? pageNumber)
        {
            ...
            //panggil db context
            var menu = from m in _context.Peminjaman.Include(p => p.IdCostumerNavigation).Include(p => p.IdJaminanNavigation) select m;
            ...
            {
                menu = menu.Where(s => s.Biaya.ToString().Contains(searchString) || s.IdCostumerNavigation.NamaCustomer.Contains(searchString) || s.IdJaminanNavigation.NamaJaminan.Contains(searchString) || s.IdKendaraanNavigation.NamaKendaraan.Contains(searchString));
            }
